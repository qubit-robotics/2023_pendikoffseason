...
class SimCameraConstants:
    ...
    minTargetArea = 500 #p  ixels^2, TODO: we will tinker with this on the real robot. Don't think we need to have massive detection distance, more fps will work better.